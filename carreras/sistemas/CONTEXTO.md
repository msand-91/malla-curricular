# Contexto — Ingeniería de Sistemas y Computación (plan 2A74)

Creada el 2026-08-17 dentro del repositorio unificado. Fuentes en `fuentes/`:
`malla_2A74_2023.pdf` (la malla oficial: códigos, créditos, agrupaciones, grafo de prerrequisitos
con círculos numerados) y `pep_enfasis_2879.pdf` (PEP del plan anterior 2879 con 12 énfasis).
