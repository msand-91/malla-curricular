...
/* ============================================================================
   ...
   pre / co: del grafo de la malla. Se han cargado las flechas que se leen sin
   ambigüedad en la imagen disponible; el resto está PENDIENTE (ver notas).
   ========================================================================== */
const PLAN_BASE = [
  /* ---------------------------- Semestre I ------------------------------- */
  ...
  /* ---------------------------- Semestre IV ------------------------------ */
  { id: '1000013', cod: '1000013', nombre: 'Probabilidad y estadística fundamental', cr: 3, sem: 4, comp: 'FP', area: 'probabilidad', pre: [], co: [],
    nota: 'Casilla «con opciones»: alternativa en el SIA, Probabilidad (2015178).' },
  { id: '2015703', cod: '2015703', nombre: 'Ingeniería económica', cr: 3, sem: 4, comp: 'FP', area: 'economicas', pre: [], co: [],
  ...
  /* ---------------------------- Semestre V ------------------------------- */
  { id: '2025970', cod: '2025970', nombre: 'Modelos y simulación', cr: 3, sem: 5, comp: 'DP', area: 'modelos', pre: [], co: [] },
  { id: '2015702', cod: '2015702', nombre: 'Gerencia y gestión de proyectos', cr: 3, sem: 5, comp: 'FP', area: 'economicas', pre: [], co: [],
    nota: 'Casilla «con opciones»: alternativa en el SIA, Diseño, gestión y evaluación de proyectos (2016028).' },
  { id: '2025967', cod: '2025967', nombre: 'Redes de computadores', cr: 3, sem: 5, comp: 'DO', area: 'infraestructura', pre: [], co: [] },
  { id: '2016701', cod: '2016701', nombre: 'Ingeniería de software I', cr: 3, sem: 5, comp: 'DO', area: 'software', pre: ['2016699'], co: [] },
  { id: '2015174', cod: '2015174', nombre: 'Introducción a la teoría de la computación', cr: 4, sem: 5, comp: 'FO', area: 'ciencias_comp', pre: ['2025964'], co: [] },
  { id: '1000047', cod: '1000047', nombre: 'Inglés IV', cr: 3, sem: 5, comp: 'NV', area: 'idioma', pre: ['1000046'], co: [] },

  /* ---------------------------- Semestre VI ------------------------------ */
  { id: '2025971', cod: '2025971', nombre: 'Optimización', cr: 3, sem: 6, comp: 'DP', area: 'modelos', pre: [], co: [] },
  { id: '2025982', cod: '2025982', nombre: 'Sistemas de información', cr: 3, sem: 6, comp: 'DP', area: 'infraestructura', pre: [], co: [] },
  { id: '2015970', cod: '2015970', nombre: 'Métodos numéricos', cr: 3, sem: 6, comp: 'FP', area: 'ciencias_comp', pre: [], co: [],
    nota: 'Casilla «con opciones»: alternativa en el SIA, Análisis numérico I (2019072).' },
  { id: '2016702', cod: '2016702', nombre: 'Ingeniería de software II', cr: 3, sem: 6, comp: 'DO', area: 'software', pre: ['2016701'], co: [] },
  { id: '2016696', cod: '2016696', nombre: 'Algoritmos', cr: 3, sem: 6, comp: 'FO', area: 'ciencias_comp', pre: ['2015174'], co: [] },
  { id: '2016707', cod: '2016707', nombre: 'Sistemas operativos', cr: 3, sem: 6, comp: 'DO', area: 'infraestructura', pre: ['2016697'], co: [] },

  /* ---------------------------- Semestre VII ----------------------------- */
  { id: '2025969', cod: '2025969', nombre: 'Modelos estocásticos y simulación en computación y comunicaciones', cr: 3, sem: 7, comp: 'DO', area: 'modelos', pre: [], co: [] },
  { id: '2025983', cod: '2025983', nombre: 'Arquitectura de infraestructura y gobierno de TICs', cr: 3, sem: 7, comp: 'DO', area: 'infraestructura', pre: [], co: [] },
  { id: '2025994', cod: '2025994', nombre: 'Teoría de la información y sistemas de comunicación', cr: 3, sem: 7, comp: 'DP', area: 'infraestructura', pre: [], co: [],
  ...
  { id: '2025966', cod: '2025966', nombre: 'Lenguajes de programación', cr: 3, sem: 7, comp: 'DP', area: 'software', pre: [], co: [] },

  /* ---------------------------- Semestre VIII ---------------------------- */
  { id: '2024045', cod: '2024045', nombre: 'Taller de proyectos interdisciplinarios', cr: 3, sem: 8, comp: 'DP', area: 'contexto', pre: [], co: [],
    nota: 'La malla lo llama «Taller interdisciplinario de creación y gestión».' },
  { id: '2025972', cod: '2025972', nombre: 'Introducción a la criptografía y a la seguridad de la información', cr: 3, sem: 8, comp: 'DP', area: 'infraestructura', pre: [], co: [],
    nota: 'La malla la llama «Codificación, criptografía y seguridad de la información».' },
  { id: '2016722', cod: '2016722', nombre: 'Computación paralela y distribuida', cr: 3, sem: 8, comp: 'DO', area: 'infraestructura', pre: ['2016707'], co: [],
  ...
  { id: '2025960', cod: '2025960', nombre: 'Computación visual', cr: 3, sem: 8, comp: 'DP', area: 'comp_aplicada', pre: [], co: [],
...
const INCONSISTENCIAS = [
  { asig: 'Prerrequisitos: parcialmente cargados', detalle: 'La malla 2A74 dibuja los prerrequisitos con flechas y círculos numerados. De la imagen disponible se transcribieron las cadenas que se leen sin ambigüedad: Matemáticas Básicas → Cálculo diferencial → Cálculo integral → Cálculo en varias variables; Cálculo diferencial → Fundamentos de mecánica y Álgebra lineal; Cálculo integral → Fundamentos de electricidad y magnetismo; Programación → Programación orientada a objetos → Estructuras de datos y Bases de datos; Estructuras de datos → Ingeniería de software I → II → Arquitectura de software; Introducción a la ingeniería → Elementos de computadores → Arquitectura de computadores → Sistemas operativos → Computación paralela; Matemáticas discretas I → II → Introducción a la teoría de la computación → Algoritmos → Sistemas inteligentes. Faltan por confirmar las flechas de Probabilidad, Redes, Modelos y simulación, Optimización, Métodos numéricos, Sistemas de información, Información y comunicaciones, Lenguajes, Criptografía y el Taller: hasta entonces se muestran sin requisito.' },
